 ...
 */
function zen_cat_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['zen_cat_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('zen_cat sample setting'),
  '#default_value' => theme_get_setting('zen_cat_example'),
